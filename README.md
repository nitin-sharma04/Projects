...
<html>
    ...
    <body onload="done()">
        <div id="scoreDiv">
            ...
            <img src="/img/coin.png" id="cn">
        </div>
        <div class="gameHome" id="startPage">
            <div id="gameTitle">Car Game</div>
        ...
        <div id="mainContainer" style="background:#0f0" >
            <img id="city" src="/img/cty.jpg">
            <canvas id="myCanvas"  ></canvas>
        </div>
        <img class="aImg" id="t1" src="/img/t1.png">
        <img class="aImg" id="t2" src="/img/t2.png">
        <img class="aImg" id="t3" src="/img/t5.png">
        <img class="aImg" id="t4" src="/img/t4.png">
        <img class="aImg" id="c1" src="/img/c2.png">
        <script>
